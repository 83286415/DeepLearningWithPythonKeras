...
step = 3  # change it into 3 from 6 to get more (doubled) time point data in the look-back time period
...
model.add(layers.Conv1D(32, 5, activation='relu',
                        input_shape=(None, float_data.shape[-1])))  # 5: ConV window. P190 the feature vectors count
